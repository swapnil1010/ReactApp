...
const LoginScreen = ({navigation}) => {
  ...
  const handleSubmitPress = () => {
    ...
    setLoading(true);
    fetch('https://localhost:44304/Practice/LoginPatient', {
      method: 'POST',
      headers: {
    ...
    // let data = { name:userEmail};  
    // axios.post("https://localhost:44304/Practice/LoginPatient", data)  
    //   .then((result) => {  
    //     navigation.replace('LiveVideoScreen');
    //   });  
          ...
          <KeyboardAvoidingView enabled>
            ...
            {/* <View style={styles.SectionStyle}>
              <TextInput
                ...
                placeholder="Enter your name" //12345
                placeholderTextColor="#8b9cb5"
